...
sintax: put 'table_name', 'rowkey', 'column_family:column_name', 'value'
...
put 'escola', '3', 'aluno:nome', 'Maria'
put 'escola', '3', 'aluno:sobrenome', 'Santos'
put 'escola', '3', 'instrutor:nome', 'Ana'
put 'escola', '3', 'avalicao:disciplina', 'Biologia'

--Buscar todos os dados da família de colunas 'aluno' da tabela 'escola'
sintax: scan 'table_name', {COLUMNS=>'column_family'}
...
sintax: scan 'table_name', {COLUMNS=>'column_family', LIMIT=>number_of_lines}
...
put 'escola', '2', 'aluno:nome', 'Paulo'

--Buscar somente a última versão do registro da família de colunas 'aluno' da tabela 'escola'
sintax: scan 'table_name', {VERSIONS=>version_number}
scan 'escola', {COLUMNS=>'aluno', VERSIONS=>1}

--Buscar somente a penúltima versão do registro da família de colunas 'aluno' da tabela 'escola'
scan 'escola', {COLUMNS=>'aluno', VERSIONS=>2}
